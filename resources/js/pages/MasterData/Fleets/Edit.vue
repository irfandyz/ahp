<template>
  <AppLayout title="Edit Fleet Vehicle">
    <div class="space-y-6 p-5">
      <!-- Header -->
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold">Edit Fleet Vehicle</h1>
          <p class="text-muted-foreground">Update vehicle information</p>
        </div>
...
const form = useForm({
  fleet_type_id: props.fleet.fleet_type_id.toString(),
  plate_number: props.fleet.plate_number,
  description: props.fleet.description || '',
})

const submit = () => {
  form.put(route('fleets.update', props.fleet.id))
}
</script>
