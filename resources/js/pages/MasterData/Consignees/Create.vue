...
const submit = () => {
    form.post('/consignees');
};
</script>

<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head title="Create Consignee" />
        ...
        <div class="space-y-6 p-5">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold">Create Consignee</h1>
                    <p class="text-muted-foreground">Add a new consignee to your system</p>
                </div>
            </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        <Button type="submit" :disabled="form.processing">
                            ...
                            {{ form.processing ? 'Creating...' : 'Create Consignee' }}
                        </Button>
                    </div>
                </form>
            </div>
